package github.com.miguelfreelancer56577.java11course.stringbuilders;
...
//        ABCD just more text because we need more text
        System.out.println("Printing value: " + builder);
        ...
        builder.toString().getChars(20, 27, myCharacterArray5, 1);
        // change destination index from 0 to 3 for String
        builder.getChars(20, 27, myCharacterArray6, 2);
